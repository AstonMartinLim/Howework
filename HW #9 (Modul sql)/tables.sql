...
-- Started on 2023-02-10 21:54:30
...
-- Name: modul_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.modul_id_seq OWNER TO postgres;

--
-- TOC entry 2840 (class 0 OID 0)
-- Dependencies: 202
-- Name: modul_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- TOC entry 205 (class 1259 OID 16544)
...
-- Name: modul id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2702 (class 2604 OID 16553)
...
--
-- TOC entry 2701 (class 2604 OID 16547)
...
--
-- TOC entry 2830 (class 0 OID 16538)
-- Dependencies: 203
-- Data for Name: modul; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.modul (id, name, pwd, email, gender) VALUES (1, 'Vasya', '21341234qwfsdf', 'mmm@mmail.com', 'm');
INSERT INTO public.modul (id, name, pwd, email, gender) VALUES (2, 'Alex', '21341234', 'mmm@gmail.com', 'm');
INSERT INTO public.modul (id, name, pwd, email, gender) VALUES (3, 'Alexey', 'qq21341234Q', 'alexey@gmail.com', 'm');
INSERT INTO public.modul (id, name, pwd, email, gender) VALUES (4, 'Helen', 'MarryMeeee', 'hell@gmail.com', 'f');
INSERT INTO public.modul (id, name, pwd, email, gender) VALUES (5, 'Jenny', 'SmakeMyb', 'eachup@gmail.com', 'f');
INSERT INTO public.modul (id, name, pwd, email, gender) VALUES (6, 'Lora', 'burn23', 'tpicks@gmail.com', 'f');


--
-- TOC entry 2834 (class 0 OID 16550)
-- Dependencies: 207
...
--
-- TOC entry 2832 (class 0 OID 16544)
-- Dependencies: 205
...
-- Dependencies: 202
-- Name: modul_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.modul_id_seq', 6, true);
...
-- Completed on 2023-02-10 21:54:32
