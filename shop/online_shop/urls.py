...
from main_app.views import ProductsListView, CreateNewProduct, ChangeProduct, ReturnProduct,\
    PurchasedProductsListView, LoginUser, LogoutUser, RegistrationNewUser, CartUser
...
urlpatterns = [
    ...
    path('return_product/', ReturnProduct.as_view(), name="return_product"),
